"""Exercise Views Tests."""
## Run the command in the line below in bash terminal ##
# python -m unittest -v  test_exercise_views.py #
print("------------------")
print("EXWECISE VIEWS TESTS")
print("------------------")
...
class TeamViewTestCase(TestCase):
    ...
    def test_exercises_show_logged_in(self):
        """ Test: can a logged-in user see all the exercises?"""
